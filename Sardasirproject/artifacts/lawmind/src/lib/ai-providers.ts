...
export const PROVIDER_INFO: Record<AIProvider, {
  ...
  groq: {
    ...
    models: [
      { id: 'llama-3.3-70b-versatile',        name: 'Llama 3.3 70B Versatile — 131K ctx ✅' },
      { id: 'llama-3.1-8b-instant',           name: 'Llama 3.1 8B Instant — 131K ctx (Fast)' },
      { id: 'openai/gpt-oss-120b',            name: 'GPT-OSS 120B — 131K ctx' },
      { id: 'openai/gpt-oss-20b',             name: 'GPT-OSS 20B — 131K ctx (Budget)' },
      { id: 'qwen/qwen3.8-27b',               name: 'Qwen 3.8 27B — 131K ctx' },
      { id: 'qwen/qwen3.6-27b',               name: 'Qwen 3.6 27B — 131K ctx' },
      { id: 'groq/compound',                  name: 'Groq Compound — 131K ctx (Agentic)' },
      { id: 'groq/compound-mini',             name: 'Groq Compound Mini — 131K ctx (Agentic)' },
      { id: 'allam-2-7b',                     name: 'Allam 2 7B — 4K ctx (Arabic)' },
    ],
    color: '#f55036',
    description: 'Ultra-fast inference — Llama 3.3 70B recommended for legal work',
  },
  openai: {
    label: 'OpenAI',
